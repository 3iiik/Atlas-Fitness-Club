        ...
        <div className="mb-8 flex flex-col items-center justify-between gap-6 sm:flex-row">
          ...
          <div className="flex gap-4">
            <a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 text-white/50 transition-all hover:border-orange-500 hover:text-orange-400"
              aria-label="Facebook"
            >
